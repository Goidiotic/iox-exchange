...
export default function SellWaitingPage() {
  ...
  return (
    <>
      <PageHeader title="Sell Waiting Room" eyebrow="Order matching" action={<Countdown seconds={3600} label="Sell window" />} />
      ...
      <Card hover={false} className="mt-4"><h2 className="font-semibold">Order details</h2><div className="mt-4 grid gap-3 sm:grid-cols-3"><div className="panel p-3">Token: {token.symbol}</div><div className="panel p-3">Quantity: 250</div><div className="panel p-3">Status: Waiting</div></div></Card>
    </>
  );
}

...
export const adminApi = {
  ...
  paymentApprovals: () => api.get('/admin/orders/payment-approvals'),
  approveOrder: (id) => api.patch(`/admin/orders/${id}/approve`, {}),
  rejectOrder: (id, reason) => api.patch(`/admin/orders/${id}/reject`, { reason }),
  approvePayment: (id) => api.patch(`/admin/orders/${id}/payment/approve`, {}),
  rejectPayment: (id, reason) => api.patch(`/admin/orders/${id}/payment/reject`, { reason }),
